        ...
        private void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this._hub.On(ConfigurationManager.AppSettings["recieve_copied_text_signalr_method_name"], delegate (String data)
                {
                    ...
                    {
                        //if (!string.Equals(lastCopy, data) || !waitCopyLoop)
                        //{
                        ...
                        this.LogWriter("->clipboard:" + data /*+ ConfigurationManager.AppSettings["copied_watermark"]*/);
                        //}
            ...
            try
            {
                ...
                if (m.Msg == NativeMethods.WM_CLIPBOARDUPDATE)
                {
                    ...
                    if (m.Msg == NativeMethods.WM_CLIPBOARDUPDATE)
                    {
                        ...
                        // && !copied_content.Contains(ConfigurationManager.AppSettings["copied_watermark"])
                        if (copied_content != null && copied_content.Length > 0)
                        {
                            if (!string.Equals(this.lastCopy, copied_content) || !waitCopyLoop)
                            {
                                ...
                                this.LogWriter("clip_change:" + copied_content);
